      ...
      <div className="grid-cyber-split">
        ...
        <div className="glass-panel" style={{ padding: '30px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            ...
            <h2 style={{ color: '#fff', fontSize: '32px', marginTop: '16px', letterSpacing: '-1px' }}>
              CyberSim mainframes
            </h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '25px', borderLeft: '2px solid rgba(0, 240, 255, 0.2)', paddingLeft: '20px' }}>
              <div style={{ fontSize: '14px' }}>
                <strong style={{ color: '#fff' }}>Interactive Security Dossiers:</strong> Secure operative dashboard showing clearance status, solved modules, and global XP rankings over the custom-built tRPC network.
              </div>
              <div style={{ fontSize: '14px' }}>
                <strong style={{ color: '#fff' }}>Hybrid WebSockets Integration:</strong> Attaches socket.io to the Next.js process via a custom hybrid node server, facilitating streaming real-time brute force dictionary execution direct to client interfaces.
              </div>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <TiltedCard maxRotate={10}>
            ...
            >
              ...
              <h3 style={{ color: '#fff', fontSize: '20px', fontFamily: 'var(--font-mono)' }}>SECURE_MAINFRAME_ACCESS</h3>
          ...
          {modules.map((mod, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 style={{ color: '#fff', fontSize: '18px', marginBottom: '8px' }}>{mod.title}</h3>
