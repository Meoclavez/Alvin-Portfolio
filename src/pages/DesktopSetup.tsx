    ...
    <div className="container-cyber">
      ...
      <div className="grid-cyber-split">
        ...
        <div className="glass-panel" style={{ padding: '30px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            ...
            <h2 style={{ color: '#fff', fontSize: '30px', marginTop: '16px', letterSpacing: '-1px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '12px', marginTop: '25px' }}>
              {specs.map((spec, index) => (
                ...
                >
                  ...
                  <span style={{ fontSize: '13px', color: '#fff', fontWeight: 600, textAlign: 'right' }}>
                    {spec.value}
                  </span>
                </div>
              ))}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <TiltedCard maxRotate={10}>
            ...
            >
              ...
              <h3 style={{ color: '#fff', fontSize: '22px', fontFamily: 'var(--font-mono)' }}>CAELESTIA_SYSTEM_V1</h3>
        ...
        <div className="grid-cyber-split" style={{ margin: '0' }}>
          ...
          <div style={{ background: 'rgba(10, 15, 25, 0.4)', border: '1px solid rgba(0, 240, 255, 0.1)', padding: '24px', borderRadius: '12px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <h3 style={{ color: '#fff', fontSize: '18px', marginBottom: '10px' }}>Plasma & Aura Backlight Sync</h3>
          ...
          <div style={{ background: 'rgba(10, 15, 25, 0.4)', border: '1px solid rgba(0, 240, 255, 0.1)', padding: '24px', borderRadius: '12px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <h3 style={{ color: '#fff', fontSize: '18px', marginBottom: '10px' }}>Caelestia Wayland Shell</h3>
              <p style={{ fontSize: '13px', color: 'var(--text-main)', lineHeight: 1.6 }}>
      ...
      <div className="glass-panel" style={{ padding: '30px', marginTop: '30px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', marginBottom: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontFamily: 'var(--font-mono)', color: '#fff', fontSize: '14px', fontWeight: 600 }}>
