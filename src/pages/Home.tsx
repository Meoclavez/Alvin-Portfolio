      ...
      <div className="bento-grid">
        ...
        >
          <div>
            ...
            <h2 style={{ color: '#fff', fontSize: '22px', marginTop: '16px' }}>PM VIKAS IoT Trainee</h2>
        ...
        >
          <div>
            ...
            <h2 style={{ color: '#fff', fontSize: '22px', marginTop: '16px' }}>CyberSim Mainframe</h2>
            <p style={{ fontSize: '14px', marginTop: '8px', color: 'var(--text-main)' }}>
        ...
        >
          <div>
            ...
            <h2 style={{ color: '#fff', fontSize: '24px', marginTop: '16px' }}>Academic & Professional Milestones</h2>
