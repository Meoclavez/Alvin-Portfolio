    ...
    <div className="container-cyber">
      ...
      >
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: '#fff', fontSize: '20px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid rgba(0, 240, 255, 0.1)', paddingBottom: '12px' }}>
        ...
        {/* IoT Embedded Column */}
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: '#fff', fontSize: '20px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid rgba(0, 255, 102, 0.1)', paddingBottom: '12px' }}>
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h2 style={{ color: '#fff', fontSize: '20px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid rgba(139, 92, 246, 0.1)', paddingBottom: '12px' }}>
      ...
      <h2 style={{ color: '#fff', fontSize: '26px', textAlign: 'center', margin: '40px 0 20px', letterSpacing: '-1px' }}>
          ...
          >
            ...
            >
              <div>
                ...
                <h3 style={{ color: '#fff', fontSize: '18px', marginTop: '16px', lineHeight: 1.3 }}>
                  {cert.title}
                </h3>
      ...
      {selectedCert && (
        ...
        >
          ...
          >
            ...
            <h3 style={{ color: '#fff', fontSize: '24px', lineHeight: 1.3, marginBottom: '8px' }}>
              {selectedCert.title}
            </h3>
            ...
            <h4 style={{ color: '#fff', fontSize: '14px', fontFamily: 'var(--font-mono)', marginBottom: '10px' }}>
